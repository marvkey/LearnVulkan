...
private:
    ...
    void CreateRenderPass() {
        ...
        // apply to the color adn depth buffer
        ...
        colorAttachmentRef.layout = VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL; // use attachmetna as colour buffer 

        VkSubpassDescription subpass{};
        subpass.pipelineBindPoint = VK_PIPELINE_BIND_POINT_GRAPHICS;

        subpass.colorAttachmentCount = 1;
        subpass.pColorAttachments = &colorAttachmentRef; // refrencing attachment 
